    ...
    <div className="min-h-screen bg-sand-50 overflow-x-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              >
                ...
                <p className="font-sans text-earth-600" style={{ fontSize: "0.88rem", fontWeight: 300, lineHeight: 1.7 }}>
                  {item.desc}
                </p>
              </div>
            ))}
      ...
      >
        ...
        >
          ...
          <p className="font-sans text-earth-400 mt-4" style={{ fontSize: "0.8rem", fontWeight: 300 }}>
